...
class CollectBackRocketTask extends Task {
    async onRun() {
        try {
            await Mep.Motion.go(new TunedPoint(-1100, 370), { speed: 180, backward: false, tolerance: -1 });
            await Mep.Motion.go(new TunedPoint(-1230, 370), { speed: 70, backward: false, tolerance: -1 });
